...
/*** 
 * Mise en place d’un test sur 3 régions d’une mécanique d’opération « -15€ dès 80€ » le jeudi et vendredi 
 * puis déploiement sur le reste du parc à partir du samedi suite aux bons résultats du test (augmentation du PM et du trafic) 
 * ==> Résultats samedi : 38% des tickets pour 60% du CA avec des tickets à + de 3 d’IV et 104€ de PM
 * 
 * 
 * */
...
SET dtdeb = DAte('2024-11-09'); -- to_date(dateadd('year', -1, $dtfin)); 
SET dtfin = DAte('2024-11-17'); -- to_date(dateadd('year', +1, $dtdeb_EXON))-1 ;  -- CURRENT_DATE();
...
and CODE_ACTIVATION IN ('FR_EMAIL_PRODUIT_LAINESHERPA0911', 'BEFR_EMAIL_PRODUIT_LSHERPA091124', 'BENL_EMAIL_PRODUIT_LSHERPA0911' )
...
SELECT * FROM DATA_MESH_PROD_CLIENT.WORK.stat_campagne ORDER BY 1,2 ;
