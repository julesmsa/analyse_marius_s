...
SET dtfin = DAte('2024-10-31'); -- to_date(dateadd('year', +1, $dtdeb_EXON))-1 ;  -- CURRENT_DATE(); 
...
Code_entite, Lib_entite, type_ferm, lib_region_com, lib_grande_region_com,
