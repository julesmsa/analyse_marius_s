...
SELECT DISTINCT LIB_FAMILLE_ACHAT, LIB_GROUPE_FAMILLE, LIB_GROUPE_FAMILLE_V2 FROM DATA_MESH_PROD_CLIENT.WORK.infoticket_N
ORDER BY 1,2,3 ;
...
SELECT DISTINCT LIB_FAMILLE_ACHAT, LIB_GROUPE_FAMILLE, LIB_GROUPE_FAMILLE_V2 FROM DATA_MESH_PROD_CLIENT.WORK.infoticket_Nm1
ORDER BY 1,2,3 ;
