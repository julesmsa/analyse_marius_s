...
, CASE WHEN (FLOOR((AGE_C) / 5) * 5) BETWEEN 15 AND 99 THEN CONCAT(FLOOR((AGE_C) / 5) * 5, '-', FLOOR((AGE_C) / 5) * 5 + 4) ELSE '999' END AS CLASSE_AGE
...
SELECT * FROM BASE_INFOCLT_TEST_SML_EXON;
...
FROM ( 
 (SELECT '00_GLOBAL' as VIZ, '00_GLOBAL' AS perimetre, '00_GLOBAL' AS typo_clt, '00_GLOBAL' AS modalite, 
    ...
    ,SUM(MONTANT_TTC)/COUNT(DISTINCT CODE_CLIENT) AS CA_PAR_CLIENT
    ,COUNT(DISTINCT id_ticket)/COUNT(DISTINCT CODE_CLIENT) AS FREQ_PAR_CLIENT
	,SUM(MONTANT_TTC)/COUNT(DISTINCT id_ticket) AS PM
	,SUM(QUANTITE_LIGNE)/COUNT(DISTINCT id_ticket) AS IDV
	,SUM(MONTANT_TTC)/SUM(QUANTITE_LIGNE) AS PVM	
...
FROM BASE_INFOCLT_TEST_SML_EXON
    GROUP BY 1,2,3,4
        ORDER BY 1,2,3,4)
UNION 
 (SELECT '00_GLOBAL' as VIZ, '00_GLOBAL' AS perimetre, '17_AGE' AS typo_clt,  CLASSE_AGE AS modalite, 
    COUNT( DISTINCT CODE_CLIENT) AS nb_clt
    ,COUNT(distinct id_ticket) AS nb_ticket
    ,SUM(MONTANT_TTC) AS CA
	,SUM(QUANTITE_LIGNE) AS qte_achete
...
UNION 
 ...
 WHEN GENDER='H' THEN '01-Hommes'
 WHEN GENDER='F' THEN '02-Femmes'
 ELSE '03-Autres/NC'  END AS perimetre, '17_AGE' AS typo_clt,  CLASSE_AGE AS modalite, 
    COUNT( DISTINCT CODE_CLIENT) AS nb_clt
    ,COUNT(distinct id_ticket) AS nb_ticket
    ,SUM(MONTANT_TTC) AS CA
	,SUM(QUANTITE_LIGNE) AS qte_achete
...
FROM BASE_INFOCLT_TEST_SML_EXON
    GROUP BY 1,2,3,4
        ORDER BY 1,2,3,4)
UNION 
 (SELECT '02_OMNICANALITE' as VIZ, CASE WHEN ID_segment_omni IS NULL OR LIB_segment_omni IS NULL THEN '9-NC/NR' ELSE CONCAT(ID_segment_omni,'_',LIB_segment_omni) END  AS perimetre, '17_AGE' AS typo_clt,  CLASSE_AGE AS modalite, 
    COUNT( DISTINCT CODE_CLIENT) AS nb_clt
    ,COUNT(distinct id_ticket) AS nb_ticket
    ,SUM(MONTANT_TTC) AS CA
	,SUM(QUANTITE_LIGNE) AS qte_achete
...
FROM BASE_INFOCLT_TEST_SML_EXON
    GROUP BY 1,2,3,4
        ORDER BY 1,2,3,4)
UNION 
 (SELECT '03_CAT_SEGMENT_RFM' as VIZ, CAT_SEGMENT_RFM AS perimetre, '17_AGE' AS typo_clt,  CLASSE_AGE AS modalite, 
    COUNT( DISTINCT CODE_CLIENT) AS nb_clt
    ,COUNT(distinct id_ticket) AS nb_ticket
    ,SUM(MONTANT_TTC) AS CA
	,SUM(QUANTITE_LIGNE) AS qte_achete
...
FROM BASE_INFOCLT_TEST_SML_EXON
    GROUP BY 1,2,3,4
        ORDER BY 1,2,3,4)
UNION 
 (SELECT '04_SEGMENT_RFM' as VIZ, CONCAT(ID_macro_segment,'_',lib_macro_segment) AS perimetre, '17_AGE' AS typo_clt,  CLASSE_AGE AS modalite, 
    COUNT( DISTINCT CODE_CLIENT) AS nb_clt
    ,COUNT(distinct id_ticket) AS nb_ticket
    ,SUM(MONTANT_TTC) AS CA
	,SUM(QUANTITE_LIGNE) AS qte_achete
...
FROM BASE_INFOCLT_TEST_SML_EXON
    GROUP BY 1,2,3,4
        ORDER BY 1,2,3,4)
UNION 
 (SELECT '05_ACTIVITE_CLT' as VIZ, CASE WHEN TOP_RECRUE=1 THEN '01-NOUVEAU' WHEN TOP_REACTIVATION=1 THEN '02-REACTIVATION' ELSE 'ACTIF 12MR' END AS perimetre, '17_AGE' AS typo_clt,  CLASSE_AGE AS modalite, 
    COUNT( DISTINCT CODE_CLIENT) AS nb_clt
    ,COUNT(distinct id_ticket) AS nb_ticket
    ,SUM(MONTANT_TTC) AS CA
	,SUM(QUANTITE_LIGNE) AS qte_achete
...
FROM BASE_INFOCLT_TEST_SML_EXON
    GROUP BY 1,2,3,4
        ORDER BY 1,2,3,4)
UNION 
 (SELECT '06_ENSEIGNE' as VIZ, CASE WHEN ID_ORG_ENSEIGNE = 1 THEN '01-JULES'  WHEN ID_ORG_ENSEIGNE = 3 THEN '02-BRICE' ELSE '03-Autres'  END AS perimetre, '17_AGE' AS typo_clt,  CLASSE_AGE AS modalite, 
    COUNT( DISTINCT CODE_CLIENT) AS nb_clt
    ,COUNT(distinct id_ticket) AS nb_ticket
    ,SUM(MONTANT_TTC) AS CA
	,SUM(QUANTITE_LIGNE) AS qte_achete
...
SELECT * FROM KPI_INFOCLT_TEST_SML; 
...
COPY INTO @dossier_export_data_/liste_mail.csv FROM 
(SELECT * FROM eco_extract_mail)
...
GET @dossier_export_data_/liste_mail.csv  /* dans ton dossier volant */
        file://C:\USERS\Econiquet\Downloads 
