...
K_Haring AS tpmag_K_Haring , Musique AS tpmag_music, P_Kodak AS tpmag_pkodak, smiley AS tpmag_smiley
...
, CASE WHEN (FLOOR((AGE) / 5) * 5) BETWEEN 15 AND 99 THEN CONCAT(FLOOR((AGE) / 5) * 5, '-', FLOOR((AGE) / 5) * 5 + 4) ELSE '99-NR/NC' END AS CLASSE_AGE
...
SELECT * FROM DATA_MESH_PROD_client.SHARED.T_OBT_SCORE_VALIUZ WHERE id_niveau=2 LIMIT 10; 
...
case when lifestyle_segment is null or lifestyle_segment IN ('',' ','-1','V') then '99-NON RENSEIGNE'
else lifestyle_segment end as lifestyle_segment_V2, 
case when CROSSCANAL_12 is null then '99-NON RENSEIGNE'
else CROSSCANAL_12 end as CROSSCANAL_12_V2, 
case when CROSSCANAL_12_24 is null then '99-NON RENSEIGNE'
else CROSSCANAL_12_24 end as CROSSCANAL_12_24_V2, 
case when CROSSCANAL_24 is null then '99-NON RENSEIGNE'
else CROSSCANAL_24 end as CROSSCANAL_24_V2, 
case when CROSSCANAL_24_36 is null then '99-NON RENSEIGNE'
else CROSSCANAL_24_36 end as CROSSCANAL_24_36_V2, 
case when CROSSCANAL_36 is null then '99-NON RENSEIGNE'
...
GROUP BY 1,2
UNION
SELECT '19_CROSSCANAL_12_24_V2' AS typo_clt,  CROSSCANAL_12_24_V2 AS modalite
 	,MIN(CASE WHEN date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then date_ticket END) AS MINDTE_KH_Glb
    ,MAX(CASE WHEN date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then date_ticket END) AS MAXDTE_KH_Glb
    ,COUNT(DISTINCT CASE WHEN Top_KHARING =1 and date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then CODE_CLIENT end) AS nb_clt_KH
    ,COUNT(DISTINCT CASE WHEN Top_KHARING =1 and date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then id_ticket END) AS nb_ticket_KH
...
GROUP BY 1,2
UNION
SELECT '20_CROSSCANAL_24_V2' AS typo_clt,  CROSSCANAL_24_V2 AS modalite
 	,MIN(CASE WHEN date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then date_ticket END) AS MINDTE_KH_Glb
    ,MAX(CASE WHEN date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then date_ticket END) AS MAXDTE_KH_Glb
    ,COUNT(DISTINCT CASE WHEN Top_KHARING =1 and date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then CODE_CLIENT end) AS nb_clt_KH
    ,COUNT(DISTINCT CASE WHEN Top_KHARING =1 and date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then id_ticket END) AS nb_ticket_KH
...
GROUP BY 1,2
UNION
SELECT '21_CROSSCANAL_24_36_V2' AS typo_clt,  CROSSCANAL_24_36_V2 AS modalite
 	,MIN(CASE WHEN date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then date_ticket END) AS MINDTE_KH_Glb
    ,MAX(CASE WHEN date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then date_ticket END) AS MAXDTE_KH_Glb
    ,COUNT(DISTINCT CASE WHEN Top_KHARING =1 and date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then CODE_CLIENT end) AS nb_clt_KH
    ,COUNT(DISTINCT CASE WHEN Top_KHARING =1 and date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then id_ticket END) AS nb_ticket_KH
...
GROUP BY 1,2
UNION
SELECT '22_CROSSCANAL_36_V2' AS typo_clt,  CROSSCANAL_36_V2 AS modalite
 	,MIN(CASE WHEN date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then date_ticket END) AS MINDTE_KH_Glb
    ,MAX(CASE WHEN date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then date_ticket END) AS MAXDTE_KH_Glb
    ,COUNT(DISTINCT CASE WHEN Top_KHARING =1 and date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then CODE_CLIENT end) AS nb_clt_KH
    ,COUNT(DISTINCT CASE WHEN Top_KHARING =1 and date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then id_ticket END) AS nb_ticket_KH
...
GROUP BY 1,2
UNION
SELECT '23_CSR_ENVIRONMENT_V2' AS typo_clt,  CSR_ENVIRONMENT_V2 AS modalite
 	,MIN(CASE WHEN date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then date_ticket END) AS MINDTE_KH_Glb
    ,MAX(CASE WHEN date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then date_ticket END) AS MAXDTE_KH_Glb
    ,COUNT(DISTINCT CASE WHEN Top_KHARING =1 and date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then CODE_CLIENT end) AS nb_clt_KH
    ,COUNT(DISTINCT CASE WHEN Top_KHARING =1 and date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then id_ticket END) AS nb_ticket_KH
...
GROUP BY 1,2
UNION
SELECT '24_CSR_HEALTHY_V2' AS typo_clt,  CSR_HEALTHY_V2 AS modalite
 	,MIN(CASE WHEN date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then date_ticket END) AS MINDTE_KH_Glb
    ,MAX(CASE WHEN date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then date_ticket END) AS MAXDTE_KH_Glb
    ,COUNT(DISTINCT CASE WHEN Top_KHARING =1 and date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then CODE_CLIENT end) AS nb_clt_KH
    ,COUNT(DISTINCT CASE WHEN Top_KHARING =1 and date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then id_ticket END) AS nb_ticket_KH
...
GROUP BY 1,2
UNION
SELECT '25_CSR_ORGANIC_V2' AS typo_clt,  CSR_ORGANIC_V2 AS modalite
 	,MIN(CASE WHEN date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then date_ticket END) AS MINDTE_KH_Glb
    ,MAX(CASE WHEN date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then date_ticket END) AS MAXDTE_KH_Glb
    ,COUNT(DISTINCT CASE WHEN Top_KHARING =1 and date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then CODE_CLIENT end) AS nb_clt_KH
    ,COUNT(DISTINCT CASE WHEN Top_KHARING =1 and date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then id_ticket END) AS nb_ticket_KH
...
GROUP BY 1,2
UNION
SELECT '26_ENSEIGNE' AS typo_clt,  CASE 
...
GROUP BY 1,2 
UNION
SELECT '27_GROUPE_FAMILLE' AS typo_clt,  
...
GROUP BY 1,2
UNION
SELECT '28_FAMILLE_PRODUITS' AS typo_clt,  
...
GROUP BY 1,2
UNION
SELECT '29_REFCO_PRODUITS' AS typo_clt,  list_refco AS modalite 
 	,MIN(CASE WHEN date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then date_ticket END) AS MINDTE_KH_Glb
    ,MAX(CASE WHEN date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then date_ticket END) AS MAXDTE_KH_Glb
    ,COUNT(DISTINCT CASE WHEN Top_KHARING =1 and date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then CODE_CLIENT end) AS nb_clt_KH
    ,COUNT(DISTINCT CASE WHEN Top_KHARING =1 and date_ticket BETWEEN DATE($dtdeb_KH) AND DATE($dtfin_KH) AND tpmag_K_Haring=1 then id_ticket END) AS nb_ticket_KH
