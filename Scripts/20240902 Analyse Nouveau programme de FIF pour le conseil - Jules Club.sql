...
SUM(CASE WHEN annul_ticket=0 AND Id_clt IS NOT NULL AND Id_clt !='0' THEN montant_remise end) AS Remise_clt,
...
SUM(CASE WHEN annul_ticket=0 AND Id_clt IS NOT NULL AND Id_clt !='0' AND cat_Jclub='01-JClub_prem' THEN montant_remise end) AS Remise_clt_Jprem,
...
SUM(CASE WHEN annul_ticket=0 AND Id_clt IS NOT NULL AND Id_clt !='0' AND cat_Jclub='02-JClub' THEN montant_remise end) AS Remise_clt_J,
...
SUM(CASE WHEN annul_ticket=0 AND Id_clt IS NOT NULL AND Id_clt !='0' AND cat_points='0_99pts' THEN montant_remise end) AS Remise_clt_000pts,
...
SUM(CASE WHEN annul_ticket=0 AND Id_clt IS NOT NULL AND Id_clt !='0' AND cat_points='100_199pts' THEN montant_remise end) AS Remise_clt_100pts,
...
SUM(CASE WHEN annul_ticket=0 AND Id_clt IS NOT NULL AND Id_clt !='0' AND cat_points='200_299pts' THEN montant_remise end) AS Remise_clt_200pts,
...
SUM(CASE WHEN annul_ticket=0 AND Id_clt IS NOT NULL AND Id_clt !='0' AND cat_points='300pts & +' THEN montant_remise end) AS Remise_clt_300pts
